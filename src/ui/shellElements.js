...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _cctvLiveEmbed: document.getElementById('cctv-live-embed'),
    _cctvLiveBtn: document.getElementById('cctv-live-btn'),
    _cctvLiveLink: document.getElementById('cctv-live-link'),
